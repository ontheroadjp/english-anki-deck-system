...
- CI/CD runs backend tests and deploys the backend API service named `dict-english` to a VPS using GitHub Secrets and SSH (`.github/workflows/ci-cd.yml:1-130`, `server/systemd/dict-english.service.example:1-32`).
