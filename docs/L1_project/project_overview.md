...
- Frontend: static HTML, CSS, and JavaScript under `web/review/` (`web/review/index.html:1-39`, `web/review/app.js:1-241`, `web/review/styles.css:1-297`).
...
- The web review UI loads `vocabulary.json`, supports text search, filters by example review status, and renders the data either as word cards or as a per-example table selectable via a tab strip (`web/review/index.html:27-35`, `web/review/app.js:31-138`, `web/review/app.js:164-208`).
